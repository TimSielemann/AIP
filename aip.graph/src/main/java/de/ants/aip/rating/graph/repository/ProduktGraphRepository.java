...
public interface ProduktGraphRepository extends GraphRepository<ProduktNode> {
	...
	@Query("MATCH (produkt:ProduktNode{produktName:{0}}), produkt<-[bestellung:"+AuftragsPositionRelation.RELATIONSHIP_TYPE+"]-(kunde)-[bestellung:"+AuftragsPositionRelation.RELATIONSHIP_TYPE+"]->(produktb) RETURN produktb")
